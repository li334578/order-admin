  ...
  <div class="orderInquiry">
    ...
    <el-card>
      ...
      <el-table :data="goodslist" border stripe class="tableColumn">
        ...
        <el-table-column label="是否已付款" prop="goods_weight" >
        ...
        <el-table-column width="200px" label="发旱状态" prop="goods_weight">
          <template slot-scope="scope" >
            <el-switch
            v-model="value"
            width="80px"
      ...
      <!-- 分页区域 -->
      <el-pagination class="pagination" @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="queryInfo.pagenum" :page-sizes="[5, 10, 15, 20]" :page-size="queryInfo.pagesize" layout="total, sizes, prev, pager, next, jumper" :total="total" background>
      </el-pagination>
    </el-card>
  </div>
</template>
