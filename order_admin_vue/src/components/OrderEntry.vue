  ...
  <div class="hello">
    <div class="baseInfoForm">
      ...
      <el-row :gutter="60" class="baseInfo">
        <el-col :span="5">
          <div class="grid-content bg-purple">
            <span>总金额</span>
            <el-input disabled v-model="orderInfo.money"></el-input>
          </div>
        </el-col>
        <el-col :span="5">
          <div class="grid-content bg-purple">
        ...
        <el-col :span="5">
          <div class="grid-content bg-purple">
            ...
            <el-input disabled v-model="orderInfo.totalArea"></el-input>
          </div>
        </el-col>
        <el-col :span="5">
          <div class="grid-content bg-purple">
    ...
    <div class="submissionList">
      ...
      >
        ...
        <el-table-column prop="area" sortable label="面积(m²)" width="120">
          <template v-slot="scope">
            <el-input
                size="small"
        ...
        <el-table-column prop="totalMoney" label="金额" width="120">
          <template v-slot="scope">
            <el-input
                size="small"
                disabled
...
export default {
  ...
  methods: {
    ...
    saveGoods(e, rowData, properties) {
      ...
      this.completeComputedMoney(rowData);
    },
    addRow(num) {
    ...
    completeComputedTotalMoney() {
      if (this.orderInfo.goodsList) {
        let moneyResult = 0;
        let areaResult = 0;
        this.orderInfo.goodsList.forEach((item) => {
          moneyResult += item.totalMoney ? item.totalMoney : 0;
          areaResult += item.area ? item.area : 0;
        });
        this.orderInfo.money = moneyResult;
        this.orderInfo.totalArea = areaResult;
      }else {
        this.orderInfo.money = 0;
        this.orderInfo.totalArea = 0;
      }
      this.$forceUpdate();
    },
    completeComputedMoney(data) {
      data.area = data.goodsWidth * data.goodsLength * data.total * 0.001 * 0.001;
      data.totalMoney = data.area * data.goodsPrice;
      this.completeComputedTotalMoney();
    },
  },
};
</script>
